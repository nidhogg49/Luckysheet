export default {
    functionlist: [{
            "n": "СУММ",
            "t": 0,
            "d": "Суммирует все аргументы.",
            "a": "Возвращает сумму всех своих аргументов.",
            "m": [1, 255],
            "p": [{
                "name": "Значение 1",
                "detail": " Первое число для сложения.",
                "example": "A2:A100",
                "require": "m",
                "repeat": "n",
                "type": "rangeall"
                ...
                "name": "Значение 2",
                "detail": " Дополнительные числа для добавления.",
                "example": "2",
                "require": "o",
                "repeat": "y",
                "type": "rangeall"
            ...
            "n": "ВЫЧЕСТЬ",
            "t": 0,
            "d": "Возвращает разницу между двумя аргументами.",
            "a": "Возвращает разницу между двумя аргументами.",
            "m": [2, 2],
            "p": [{
                "name": "Уменьшаемое",
                "detail": " число, из которого осуществляется вычетание.",
                "example": "A2",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
            ...
            "a": "Возвращает произведение аргументов.",
            "m": [2, 2],
            "p": [{
                "name": "Число 1",
            ...
            "n": "РАЗДЕЛИТЬ",
            "t": 0,
            "d": "Возвращает частное двух чисел.",
            "a": "Возвращает частное двух чисел.",
            "m": [2, 2],
            "p": [{
                "name": "Делимое",
                ...
                "name": "Делитель",
                "detail": "количество частей, на которое делится Делимое.",
                "example": "2",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
            ...
            "n": "СРЗНАЧ",
            "t": 1,
            "d": "Возвращает среднее значение (среднее арифмитическое) аргументов.",
            "a": "Возвращает среднее значение (среднее арифмитическое) аргументов.",
            "m": [1, 255],
            "p": [{
                "name": "Значение 1",
                "detail": "первое число для расчета среднего значения.",
                "example": "A2:A100",
                "require": "m",
                "repeat": "n",
                "type": "rangeall"
                ...
                "name": "Значение 2",
                "detail": "дополнительное число для расчета среднего значения.",
                "example": "B2:B100",
                "require": "o",
                "repeat": "y",
                "type": "rangeall"
            ...
            "n": "IRR",
            "t": 8,
            "d": "Возвращает внутреннюю ставку доходности для ряда потоков денежных средств, представленых численными значениями.",
            "a": "Внутренняя ставка доходности - это процентная ставка, принимаемая для инвестиции, состоящей из платежей (отрицательные величины) и доходов (положительные величины), которые имеют место в следующие друг за другом и одинаковые по продолжительности периоды.",
            "m": [1, 2],
            "p": [{
                "name": "Значнения",
                "detail": "обязательный аргумент. Массив или ссылка на ячейки, содержащие числа, для которых требуется подсчитать внутреннюю ставку доходности.",
                "example": "A2:A25",
                "require": "m",
                "repeat": "n",
                "type": "range"
                ...
                "name": "Предположение",
                "detail": "необязательный аргумент. Величина, предположительно близкая к результату IRR.",
                "example": "200",
                "require": "o",
                "repeat": "n",
                "type": "rangenumber"
            ...
            "n": "NPV",
            "t": 8,
            "d": "Возвращает величину чистой приведённой стоимости инвестиции, используя ставку дисконтирования, а также последовательность будущих выплат (отрицательные значения) и поступлений (положительные значения).",
            "a": "Возвращает величину чистой приведённой стоимости инвестиции, используя ставку дисконтирования, а также последовательность будущих выплат (отрицательные значения) и поступлений (положительные значения).",
            "m": [2, 255],
            "p": [{
                "name": "Ставка",
                "detail": "Обязательный аргумент. Ставка дисконтирования за один период.",
                "example": "0.1",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
                ...
                "name": "Значение 1",
                "detail": "выплаты и поступления, равностоящие друг от друга по времени и проходящие в конце каждого периода.",
                "example": "200",
                "require": "m",
                "repeat": "n",
                "type": "rangeall"
            ...
            "n": "ПЛТ",
            "t": 8,
            "d": "Возвращает сумму периодического платежа для аннуитета на основе постоянства сумм платежей и постоянной процентной ставки.",
            "a": "Возвращает сумму периодического платежа для аннуитета на основе постоянства сумм платежей и постоянной процентной ставки.",
            "m": [3, 5],
            "p": [{
                "name": "Ставка",
                "detail": "обязательный аргумент. Процентная ставка по ссуде.",
                "example": "0.08",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
                ...
                "name": "Кпер",
                "detail": "обязательный аргумент. Общее число выплат по ссуде.",
                "example": "12",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
                ...
                "name": "Пс",
                "detail": "обязательный аргумент. Приведённая к текущему моменту стоимость или общая сумма, которая на текущий момент равноценна ряду будущих платежей, называемая так же основной суммой.",
                "example": " 100000",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
                ...
                "name": "Бс",
                "detail": "необязательный. Значениебудущей стоимости, т.е. желаемого остатка средств после последнего платежа. Если аргумент 'бс' опущен предполагается, что он равен 0 ( например, будущая стоимость для займа равна 0).",
                "example": "D2",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
                ...
                "name": "Тип",
                "detail": "необязательный аргумент. Число 0 (нуль) или 1, обозначающее, когда должна проводиться выплата.",
                "example": "1",
                "require": "m",
                "repeat": "n",
                "type": "rangenumber"
    ...
    fontarray: ["SBSans", "Times New Roman", "Arial", "Tahoma", "Verdana"],
    fontjson: {
        "SBSans": 0,
        "times new roman": 1,
        "arial": 2,
    ...
    formulaMore: {
        valueTitle: "Значение ",
        tipSelectDataRange: "Введите аргументы",
        tipDataRangeTile: "Аргументы фугкции",
        findFunctionTitle: "Найти функцию",
        tipInputFunctionName: "Имя функции или её описание",
    ...
    protection: {
        ...
        defaultSheetHintText: "Ввод инфорации в выбранную область невозможен.",
    },
    cellFormat: {
